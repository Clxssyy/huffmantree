/*
    ...
    Implementation file for the Huffman struct and Encoded struct
*/
...
private:
    ...
    void create_freq(const std::string& string);
    void create_codes(HNode* node, const std::string& code);
    void serialize_tree(HNode*, std::string& string);
    void encode_string(const std::string& input, std::string& encoded_string);
...
public:
    ...
    Encoded encode(const std::string& string);
};
